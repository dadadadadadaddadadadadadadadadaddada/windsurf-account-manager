...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::account::get_setting,
            commands::account::set_setting,
            commands::account::create_group,
            commands::account::list_groups,
            commands::account::set_accounts_group,
            commands::account::rename_group,
            commands::account::delete_group,
